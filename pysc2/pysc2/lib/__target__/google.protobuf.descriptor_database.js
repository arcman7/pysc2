...
export var DescriptorDatabase =  __class__ ('DescriptorDatabase', [object], {
	...
	get Add () {return __get__ (this, function (self, file_desc_proto) {
		...
		for (var enum of file_desc_proto.enum_type) {
			...
			for (var enum_value of enum.value) {
				self._file_desc_protos_by_symbol ['.'.join (tuple ([package, enum_value.py_name]))] = file_desc_proto;
			}
		}
		...
		try {
			...
			if (isinstance (__except0__, KeyError)) {
				...
				try {
					...
					if (isinstance (__except1__, KeyError)) {
						var __except2__ = KeyError (symbol);
						__except2__.__cause__ = null;
						throw __except2__;
					}
					else {
						throw __except1__;
	...
	get FindFileContainingExtension () {return __get__ (this, function (self, extendee_name, extension_number) {
		return null;
	});},
	get FindAllExtensionNumbers () {return __get__ (this, function (self, extendee_name) {
		return [];
	});},
