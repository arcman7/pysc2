...
import * as symbol_database from './google.protobuf.symbol_database.js';
...
export var Message =  __class__ ('Message', [object], {
	...
	get UnknownFields () {return __get__ (this, function (self) {
		var __except0__ = NotImplementedError;
		__except0__.__cause__ = null;
		throw __except0__;
	});},
	...
	get __setstate__ () {return __get__ (this, function (self, state) {
		self.__init__ ();
		var serialized = state ['serialized'];
		if (!(isinstance (serialized, bytes))) {
			var serialized = serialized.encode ('latin1');
		}
		self.ParseFromString (serialized);
	});},
	get __reduce__ () {return __get__ (this, function (self) {
		var message_descriptor = self.DESCRIPTOR;
		if (message_descriptor.containing_type === null) {
			return tuple ([py_typeof (self), tuple ([]), self.__getstate__ ()]);
		}
		var container = message_descriptor;
		return tuple ([_InternalConstructMessage, tuple ([container.full_name]), self.__getstate__ ()]);
	});}
});
export var _InternalConstructMessage = function (full_name) {
